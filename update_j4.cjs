...
const oldJ4Start = content.indexOf("id: 'journey4'");
const oldBlockStart = content.lastIndexOf("{", oldJ4Start);
...
content = content.substring(0, oldBlockStart) + newJ4;
fs.writeFileSync('src/lib/journeysData.ts', content);
console.log('Journey 4 updated safely!');
