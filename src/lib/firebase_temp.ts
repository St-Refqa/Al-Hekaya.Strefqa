...
const supabaseUrl = ({} as any).VITE_SUPABASE_URL || 'https://nssuihqftjpojeakupfj.supabase.co';
const supabaseKey = ({} as any).VITE_SUPABASE_ANON_KEY || 'sb_publishable_un9YUbLKIr-QypqU45QyBQ_crgIgAgS';
