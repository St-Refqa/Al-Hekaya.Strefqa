  ...
  async checkAndInjectWeeklyReminders() {
    try {
      ...
      if (day === 6) { // Saturday -> OT meeting
        targetGroup = "OT";
        title = "تذكير باجتماع طلاب اونلاين اليوم! ⛪";
        message = "مستنيينك النهاردة الساعة 7:00 مساءً في اجتماع طلاب اونلاين. متنساش كارت الحضور الرقمي (QR) بتاعك لتسجيل نقاط حضورك اليوم! 🌟";
        tag = `OT_MEET_${weekId}`;
      } else if (day === 4) { // Thursday -> NT meeting
        targetGroup = "NT";
        title = "تذكير باجتماع طلاب الورشة اليوم! ⛪";
        message = "مستنيينك النهاردة الساعة 7:00 مساءً في اجتماع طلاب الورشة. متنساش كارت الحضور الرقمي (QR) بتاعك لتسجيل نقاط حضورك اليوم! 🌟";
        tag = `NT_MEET_${weekId}`;
      }
        ...
        for (const item of schedule) {
          ...
          if (diffHours >= 0 && diffHours <= 12) {
            ...
            if (snap.empty) {
              ...
              if (type === "OT") {
                title = `⏰ تذكير: اجتماع طلاب اونلاين بعد 12 ساعة!`;
                if (isSpecial) {
                  ...
                  message = `مستنيينك النهاردة الساعة 7:00 مساءً في اجتماع طلاب اونلاين. موضوعات اليوم الشائقة هي - الفقرة الأولى: "${item.topic1}"${item.topic2 ? ` | والفقرة الثانية: "${item.topic2}"` : ""}. متنساش كارت الحضور الرقمي (QR) لتسجيل نقاط حضورك الفوري! ⛪✨`;
                }
              } else {
                title = `⏰ تذكير: اجتماع طلاب الورشة بعد 12 ساعة!`;
                if (isSpecial) {
                  ...
                  message = `مستنيينك النهاردة الساعة 7:00 مساءً في اجتماع طلاب الورشة. موضوعات اليوم الشائقة هي - الفقرة الأولى: "${item.topic1}"${item.topic2 ? ` | والفقرة الثانية: "${item.topic2}"` : ""}. متنساش كارت الحضور الرقمي (QR) لتسجيل نقاط حضورك الفوري! ⛪✨`;
                }
              }
