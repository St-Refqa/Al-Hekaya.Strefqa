...
export function StudentSidebar({ isOpen, onClose }: SidebarProps) {
  ...
  if (user?.code?.toUpperCase().startsWith('S')) {
    menuItems.push({ icon: Cloud, label: 'بوابة Google', path: '/student/workspace' });
  }
            ...
            {user && (
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 rounded-2xl bg-white p-1 shadow-sm border border-brand-beige/10 overflow-hidden shrink-0 group-hover:scale-105 transition-transform">
                    {user.photoUrl ? (
          ...
          <div className="p-6 mt-auto space-y-3 bg-brand-cream/20 border-t border-brand-beige/5">
            <div className="flex items-center gap-2 w-full">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-3 p-3.5 rounded-2xl bg-white border border-brand-beige/10 text-brand-beige hover:text-rose-600 hover:bg-rose-50 transition-all font-black text-[11px] uppercase tracking-wider group"
              >
            ...
            <div className="text-center pt-2">
              <div className="flex items-center justify-center gap-2 opacity-20">
                <div className="h-[1px] w-4 bg-brand-beige" />
