...
export default function StudentLeaderboard() {
  ...
  const [userBadges, setUserBadges] = useState<Record<string, number>>({});
  ...
  useEffect(() => {
    // Fetch users data to ensure photos and badges show even for old submissions
    const fetchStudentData = async () => {
      try {
        ...
        usersSnap.forEach(doc => {
          ...
          if (data.photoUrl) {
            photoMap[doc.id] = data.photoUrl;
          }
          if (data.badges) {
            badgeMap[doc.id] = data.badges.length;
          }
        });
  ...
  const leaderboardData = useMemo(() => {
    ...
    submissions.forEach(s => {
      ...
      if (!participants[pId]) {
        participants[pId] = {
          ...
          avgAccuracy: 0,
          streak: 0,
          photoUrl: userPhotos[pId] || s.participantPhotoUrl,
          badgeCount: userBadges[pId] || 0
        };
      }
      participants[pId].totalScore += s.finalScore;
    ...
    return Object.values(participants)
      .map(p => ({
        ...
        photoUrl: userPhotos[p.id] || p.photoUrl,
        badgeCount: userBadges[p.id] || p.badgeCount || 0
      }))
      .filter(p => !searchTerm || p.name.toLowerCase().includes(searchTerm.toLowerCase()))
      .sort((a, b) => b.totalScore - a.totalScore || b.avgAccuracy - a.avgAccuracy);
  }, [submissions, searchTerm, userPhotos, userBadges]);
        ...
        <div className="space-y-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-end max-w-5xl mx-auto px-4">
            ...
            {top3[1] && (
              ...
              >
                <div className="relative mb-4 md:mb-6">
                  <div className="w-16 h-16 sm:w-24 lg:w-28 rounded-xl sm:rounded-3xl lg:rounded-[32px] bg-white shadow-2xl flex items-center justify-center text-brand-beige font-black text-xl sm:text-3xl lg:text-4xl border-4 border-slate-200 group-hover:scale-105 transition-transform duration-500 overflow-hidden">
                    {top3[1].photoUrl ? (
                ...
                <div className="text-center mb-4 lg:mb-8">
                  ...
                  <div className="flex flex-col gap-1 items-center">
                    ...
                    <div className="flex items-center gap-1 text-emerald-600 text-[10px] font-black">
                      ...
                      <span>{userBadges[top3[1].id] || 0} أوسمة</span>
                    </div>
                  </div>
                </div>
            ...
            {top3[0] && (
              ...
              >
                <div className="relative mb-6 md:mb-8 pt-4 sm:pt-0">
                  ...
                  <div className="w-20 h-20 sm:w-36 rounded-2xl sm:rounded-[40px] bg-white shadow-[0_20px_50px_rgba(251,191,36,0.15)] flex items-center justify-center text-brand-red font-black text-2xl sm:text-5xl border-4 border-amber-400 overflow-hidden ring-4 sm:ring-8 ring-amber-400/5 relative">
                     {top3[0].photoUrl ? (
                ...
                <div className="text-center mb-6 lg:mb-10">
                  ...
                  <div className="flex flex-col gap-1.5 lg:gap-2 items-center">
                    ...
                    <div className="flex items-center gap-1 text-amber-600 text-[10px] font-black">
                      ...
                      <span>{userBadges[top3[0].id] || 0} أوسمة للملك</span>
                    </div>
                  </div>
                </div>
            ...
            {top3[2] && (
              ...
              >
                <div className="relative mb-4 md:mb-6">
                  <div className="w-16 h-16 sm:w-24 lg:w-28 rounded-xl sm:rounded-3xl lg:rounded-[32px] bg-white shadow-2xl flex items-center justify-center text-brand-beige font-black text-xl sm:text-3xl lg:text-4xl border-4 border-amber-100 group-hover:scale-105 transition-transform duration-500 overflow-hidden">
                    {top3[2].photoUrl ? (
                ...
                <div className="text-center mb-4 lg:mb-8">
                  ...
                  <div className="flex flex-col gap-1 items-center">
                    ...
                    <div className="flex items-center gap-1 text-emerald-600 text-[10px] font-black">
                      <Medal className="w-3 h-3" />
                      <span>{userBadges[top3[2].id] || 0} أوسمة</span>
                    </div>
                  </div>
                </div>
