        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-24 relative z-10">
          <div className="flex flex-col items-center text-center space-y-16">
            ...
            <motion.div 
              ...
              className="grid grid-cols-4 gap-2 sm:gap-6 w-full"
            >
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  className="flex flex-col items-center justify-center p-2 sm:p-6 rounded-[20px] sm:rounded-[32px] bg-white border border-brand-beige/10 hover:border-transparent transition-all shadow-sm hover:shadow-2xl hover:shadow-brand-beige/20 group relative overflow-hidden"
                >
                   ...
                   <div className={cn("relative z-10 w-10 h-10 sm:w-16 sm:h-16 rounded-[14px] sm:rounded-3xl flex items-center justify-center text-white transition-all duration-500 group-hover:scale-110 group-hover:rotate-6 shadow-xl mb-1 sm:mb-4", social.color)}>
                      <social.icon className="w-5 h-5 sm:w-8 sm:h-8" />
                   </div>
                   <div className="relative z-10 text-center">
                      <span className="font-black text-brand-text text-[10px] sm:text-xl block mb-0 sm:mb-1 group-hover:text-brand-red transition-colors truncate">{social.name}</span>
                      <span className="text-[9px] sm:text-[10px] font-black text-brand-beige uppercase tracking-wider hidden sm:block">تابع حكاياتنا</span>
                   </div>
                </motion.a>
              ))}
            </motion.div>
