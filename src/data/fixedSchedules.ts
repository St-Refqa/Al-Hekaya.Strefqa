...
export const saturdaySchedules: ScheduleItem[] = [
  { date: "13 / 6", dayText: "السبت", topic1: "البشارة و الميلاد و رحلة العائلة المقدسة", topic2: "مقارنة الأربع أناجيل" },
  { date: "20 / 6", dayText: "السبت", topic1: "بدايات الخدمة", topic2: "خلفية تاريخية" },
  { date: "27 / 6", dayText: "السبت", topic1: "الخدمة الأولى في اليهودية", topic2: "خلفية جغرافية" },
  { date: "4 / 7", dayText: "السبت", topic1: "الخدمة العظيمة في الجليل", topic2: "الخلفية الثقافية والاجتماعية" },
  { date: "11 / 7", dayText: "السبت", topic1: "الخدمة الأخيرة في اليهودية وإقليم بيرية", topic2: "الخلفية الدينية اليهودية" },
  { date: "18 / 7", dayText: "السبت", topic1: "أسبوع الآلام", topic2: "الخلفية السياسية والاقتصادية" },
  { date: "25 / 7", dayText: "السبت", topic1: "أعمال الرسل 1 - 12", topic2: "الخلفية اللغوية (عبري - آرامي - يوناني)" },
  { date: "1 / 8", dayText: "السبت", topic1: "رحلات بولس الرسول 1 و 2", topic2: "النبوات والرموز في العهد القديم وتحقيقها في العهد الجديد" },
  ...
  { date: "22 / 8", dayText: "السبت", topic1: "رحلات 3 وروما", topic2: "امتحان Round 1 📝", isSpecialEvent: true },
  { date: "29 / 8", dayText: "السبت", topic1: "بانوراما رسائل بولس 1", topic2: "طرق دراسة الكتاب 1" },
  { date: "5 / 9", dayText: "السبت", topic1: "بانوراما رسائل بولس 2", topic2: "طرق دراسة الكتاب 2" },
  { date: "12 / 9", dayText: "السبت", topic1: "نهضة القديسة رفقة ⛪✨", isSpecialEvent: true },
  { date: "19 / 9", dayText: "السبت", topic1: "رسائل الجامعة", topic2: "الرموز والأرقام في الكتاب المقدس" },
  { date: "26 / 9", dayText: "السبت", topic1: "سفر الرؤيا 1", topic2: "كيف انتشرت المسيحية" },
  { date: "3 / 10", dayText: "السبت", topic1: "سفر الرؤيا 2", topic2: "امتحان Round 2 📝", isSpecialEvent: true }
];
